<?php
/**
 * Template Name: آموزش خصوصی هوش مصنوعی (تخصصی)
 */

custom_header(); ?>

<style>
    /* Modern AI Private Training Styles */
    .learning-container {
    ...
    <div class="learning-container ai-specialized">

        <!-- Hero Section -->
        <div class="learning-hero ai-hero">
            <h1>🤖 تدریس خصوصی هوش مصنوعی</h1>
            <p>یادگیری هوش مصنوعی همراه با تمرین اختصاصی، <strong>بر اساس هدف، سطح و زمان شما</strong></p>
        ...
        <section id="why-private" class="section">
            <h2 class="section-title">چرا آموزش خصوصی هوش مصنوعی؟</h2>
        ...
        <section class="section">
            ...
            <div class="paths-grid">
                <div class="path-card">
                    <h4>🧠 یادگیری ماشین</h4>
                    <p>Scikit-learn, Pandas, NumPy, Feature Engineering</p>
                </div>
                <div class="path-card">
                    <h4>🔍 پردازش زبان طبیعی</h4>
                    <p>NLP, Transformers, BERT, GPT, Text Analysis</p>
                </div>
                <div class="path-card">
                    <h4>👁️ بینایی ماشین</h4>
                    <p>OpenCV, TensorFlow, Computer Vision, Image Processing</p>
                </div>
                <div class="path-card">
                    <h4>🤖 یادگیری عمیق</h4>
                    <p>Neural Networks, PyTorch, TensorFlow, CNN, RNN</p>
                </div>
            </div>
        </section>
        ...
        <section class="section">
            ...
            <div class="projects-grid">
                <div class="project-card">
                    ...
                    <h3>سیستم پیش‌بینی فروش</h3>
                    <p>مدل یادگیری ماشین برای پیش‌بینی فروش محصولات</p>
                ...
                <div class="project-card">
                    <div class="project-icon">💬</div>
                    <h3>چت‌بات هوشمند</h3>
                    <p>ربات گفتگو با پردازش زبان طبیعی</p>
                    <div class="project-tech">
                        <span class="tech-tag">Python</span>
                ...
                <div class="project-card">
                    ...
                    <h3>تشخیص چهره AI</h3>
                    <p>سیستم تشخیص چهره با OpenCV و یادگیری عمیق</p>
                    <div class="project-tech">
                ...
                <div class="project-card">
                    <div class="project-icon">📊</div>
                    <h3>تحلیل احساسات متن</h3>
                    <p>تحلیل احساسات نظرات مشتریان با NLP</p>
                    <div class="project-tech">
                        <span class="tech-tag">Python</span>
                ...
                <div class="project-card">
                    <div class="project-icon">🎵</div>
                    <h3>تولید موسیقی AI</h3>
                    <p>تولید موسیقی با شبکه‌های عصبی</p>
                    <div class="project-tech">
                        <span class="tech-tag">Python</span>
                ...
                <div class="project-card">
                    <div class="project-icon">🏥</div>
                    <h3>تشخیص بیماری از تصویر</h3>
                    <p>تشخیص بیماری‌های پوستی با Computer Vision</p>
                    <div class="project-tech">
                        <span class="tech-tag">TensorFlow</span>
                        <span class="tech-tag">CNN</span>
                    ...
                    <div class="project-difficulty">
                        <span class="difficulty-label">سطح: پیشرفته</span>
                        <span class="difficulty-bar">
                            <span class="difficulty-fill" style="width: 95%"></span>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <section class="section instructor-section">
            ...
            <div class="instructor-card">
                ...
                <div class="instructor-info">
                    <h3>محمدجوادسرلک</h3>
                    <p>9+ سال تجربه در هوش مصنوعی و آموزش برنامه‌نویسی</p>
        ...
        <!-- Testimonials (AI-focused) -->
        <section class="testimonials-section" id="testimonials-section">
            <h2 class="section-title">نظرات دانشجویان هوش مصنوعی</h2>
            <p style="text-align: center; color: #cbd5e1; margin-bottom: 2rem;">
                        ...
                        <div class="testimonial-card">
                            ...
                            <?php if ($audio_url) : ?>
                                <div class="voice-player">
                                    <audio controls style="width: 100%; height: 45px; border-radius: 15px; background: rgba(168, 85, 247, 0.1); border: 1px solid rgba(168, 85, 247, 0.3);">
        ...
        <section class="free-class-cta ai-cta">
            <h2>🎯 جلسه رایگان — با هدف مشخص!</h2>
            <p>در جلسه اول، هدف شما را بررسی می‌کنیم و یک برنامهٔ شخصی‌سازی‌شده طراحی می‌کنیم.</p>
            <div class="cta-options">
                <button class="cta-btn" data-goal="ML">یادگیری ماشین</button>
                <button class="cta-btn" data-goal="NLP">پردازش زبان طبیعی</button>
                <button class="cta-btn" data-goal="CV">بینایی ماشین</button>
                <button class="cta-btn" data-goal="DL">یادگیری عمیق</button>
    ...
    <div class="modal-overlay" id="registrationModal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">جلسه رایگان هوش مصنوعی</h3>

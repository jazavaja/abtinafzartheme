<?php
/**
 * Template Name: آموزش خصوصی پایتون (تخصصی)
 */

custom_header(); ?>

<style>
    /* Modern Python Private Training Styles */
    .learning-container {
    ...
    <div class="learning-container python-specialized">

        <!-- Hero Section -->
        <div class="learning-hero python-hero">
            <h1>🐍 تدریس خصوصی پایتون</h1>
            <p>یادگیری پایتون همراه با تمرین اختصاصی، <strong>بر اساس هدف، سطح و زمان شما</strong></p>
        ...
        <section id="why-private" class="section">
            <h2 class="section-title">چرا آموزش خصوصی پایتون؟</h2>
        ...
        <section class="section">
            ...
            <div class="paths-grid">
                <div class="path-card">
                    <h4>📊 علم داده و تحلیل داده</h4>
                    <p>Pandas, NumPy, Matplotlib, Scikit-learn</p>
                </div>
                <div class="path-card">
                    <h4>🌐 توسعه وب (Django/Flask)</h4>
                    <p>REST API, ORM, Authentication, Deployment</p>
                </div>
                <div class="path-card">
                    <h4>🤖 هوش مصنوعی / یادگیری ماشین</h4>
                    <p>TensorFlow, PyTorch, NLP, Computer Vision</p>
                </div>
                <div class="path-card">
                    <h4>⚙️ اتوماسیون و اسکریپت‌نویسی</h4>
                    <p>فایل‌ها، وب‌اسکرپینگ، ربات‌ها، GUI</p>
                </div>
            </div>
        </section>
        ...
        <section class="section">
            ...
            <div class="projects-grid">
                <div class="project-card">
                    ...
                    <h3>ربات تلگرام هوشمند</h3>
                    <p>مدیریت وظایف، یادآوری‌ها و اتوماسیون پیام‌ها</p>
                ...
                <div class="project-card">
                    ...
                    <p>تحلیل فروش، گزارش‌گیری و نمودارهای تعاملی</p>
                    <div class="project-tech">
                ...
                <div class="project-card">
                    ...
                    <p>سایت کامل با Django، پرداخت و مدیریت سفارش</p>
                    <div class="project-tech">
                ...
                <div class="project-card">
                    ...
                    <h3>تشخیص چهره AI</h3>
                    <p>سیستم تشخیص چهره با OpenCV و یادگیری ماشین</p>
                    <div class="project-tech">
                ...
                <div class="project-card">
                    <div class="project-icon">⚙️</div>
                    <h3>اتوماسیون گزارش‌ها</h3>
                    <p>اسکریپت خودکار برای تولید گزارش‌های ماهانه</p>
                    <div class="project-tech">
                        <span class="tech-tag">Pandas</span>
                    ...
                    <div class="project-difficulty">
                        ...
                        <span class="difficulty-bar">
                            <span class="difficulty-fill" style="width: 40%"></span>
                        </span>
                    </div>
                </div>
                ...
                <div class="project-card">
                    <div class="project-icon">🌐</div>
                    <h3>وب‌اسکرپر هوشمند</h3>
                    <p>جمع‌آوری داده از وب‌سایت‌ها و تحلیل آن‌ها</p>
                    <div class="project-tech">
        ...
        <section class="section instructor-section">
            ...
            <div class="instructor-card">
                ...
                <div class="instructor-info">
                    <h3>محمدجوادسرلک</h3>
                    <p>9+ سال تجربه در توسعه پایتون و آموزش برنامه‌نویسی</p>
        ...
        <!-- Testimonials (Python-focused) -->
        <section class="testimonials-section" id="testimonials-section">
            <h2 class="section-title">نظرات دانشجویان پایتون</h2>
            <p style="text-align: center; color: #cbd5e1; margin-bottom: 2rem;">
        ...
        <section class="free-class-cta python-cta">
            <h2>🎯 جلسه رایگان — با هدف مشخص!</h2>
            <p>در جلسه اول، هدف شما را بررسی می‌کنیم و یک برنامهٔ شخصی‌سازی‌شده طراحی می‌کنیم.</p>
            <div class="cta-options">
                <button class="cta-btn" data-goal="داده">علم داده</button>
                <button class="cta-btn" data-goal="وب">توسعه وب</button>
                <button class="cta-btn" data-goal="هوش">هوش مصنوعی</button>
                <button class="cta-btn" data-goal="اتوماسیون">اتوماسیون</button>
    ...
    <div class="modal-overlay" id="registrationModal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">جلسه رایگان پایتون</h3>

...
/**
 * Template Name: آموزش خصوصی Django (تخصصی)
 */

custom_header(); ?>

<style>
    /* Modern Django Private Training Styles */
    .learning-container {
    ...
    /* Hero Section */
    .django-hero {
        background: linear-gradient(135deg, #065f46 0%, #0955a3 50%, #002bff 100%) color: white;
        position: relative;
        overflow: hidden;
        border-radius: 24px;
        margin-bottom: 4rem;
    ...
    /* CTA Section */
    .django-cta {
        background: linear-gradient(135deg, rgb(59, 86, 238) 0%, rgb(57, 6, 196) 50%, rgb(12, 41, 209) 100%);
        border-radius: 24px;
        padding: 4rem 2rem;
        text-align: center;
        position: relative;
...
<div class="learning-container django-specialized">

    <!-- Hero Section -->
    <div class="learning-hero django-hero">
        <h1>🌐 تدریس خصوصی Django — توسعه وب حرفه‌ای</h1>
        <p>یادگیری جنگو نه با ویدیوهای ضبط‌شدهٔ عمومی، بلکه <strong>زنده، پروژه‌محور و کاملاً متناسب با سطح و هدف شما</strong>.</p>
    ...
    <section id="why-private" class="section">
        <h2 class="section-title">چرا آموزش خصوصی Django؟</h2>
        <div class="comparison-grid">
            <div class="comparison-card">
                <h3>آموزش گروهی</h3>
                <ul>
                    <li>پروژه‌های عمومی و تکراری</li>
                    <li>سوالات محدود</li>
            ...
            <div class="comparison-card highlight">
                ...
                <ul>
                    <li>✅ پروژه‌های <strong>واقعی و کاربردی</strong></li>
    ...
    <section class="section">
        ...
        <div class="paths-grid">
            <div class="path-card">
                ...
                <p>Django + PostgreSQL + Stripe + Redis</p>
            </div>
            <div class="path-card">
                <h4>📊 پنل مدیریت</h4>
                <p>Django Admin, Custom Dashboard, Reports</p>
            </div>
            <div class="path-card">
                <h4>🔐 API و احراز هویت</h4>
                <p>Django REST Framework, JWT, OAuth</p>
            </div>
            <div class="path-card">
                <h4>☁️ DevOps و Deploy</h4>
                <p>Docker, Nginx, AWS, CI/CD</p>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div class="projects-grid">
            ...
            <div class="project-card">
                ...
                <p>CMS کامل با ویرایشگر WYSIWYG و مدیریت کاربران</p>
                <div class="project-tech">
                    <span class="tech-tag">Django</span>
            ...
            <div class="project-card">
                ...
                <p>JWT, OAuth, 2FA و مدیریت نقش‌ها</p>
                <div class="project-tech">
            ...
            <div class="project-card">
                <div class="project-icon">💬</div>
                <h3>سیستم چت آنلاین</h3>
                <p>چت real-time با WebSocket و Django Channels</p>
                <div class="project-tech">
            ...
            <div class="project-card">
                <div class="project-icon">📧</div>
                <h3>سیستم ایمیل مارکتینگ</h3>
                <p>ارسال ایمیل‌های انبوه و مدیریت لیست‌ها</p>
                <div class="project-tech">
                    <span class="tech-tag">Django</span>
                    <span class="tech-tag">Celery</span>
    ...
    <section class="section instructor-section">
        ...
        <div class="instructor-card">
            ...
            <div class="instructor-info">
                <h3>محمدجوادسرلک</h3>
                <p>9+ سال تجربه در توسعه Django و آموزش برنامه‌نویسی</p>
    ...
    <section class="testimonials-section" id="testimonials-section">
        <h2 class="section-title">نظرات دانشجویان Django</h2>
        <p style="text-align: center; color: #cbd5e1; margin-bottom: 2rem;">
                    ...
                    <div class="testimonial-card">
                        ...
                        <?php if ($audio_url) : ?>
                            <div class="voice-player">
                                <audio controls style="width: 100%; height: 45px; border-radius: 15px; background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3);">
    ...
    <section class="free-class-cta django-cta">
        <h2>🎯 جلسه رایگان — با هدف مشخص!</h2>
        <p>در جلسه اول، هدف شما را بررسی می‌کنیم و یک برنامهٔ شخصی‌سازی‌شده طراحی می‌کنیم.</p>
        <div class="cta-options">
            <button class="cta-btn" data-goal="فروشگاه">فروشگاه آنلاین</button>
            <button class="cta-btn" data-goal="پنل">پنل مدیریت</button>
            <button class="cta-btn" data-goal="API">API و احراز هویت</button>
            <button class="cta-btn" data-goal="DevOps">DevOps و Deploy</button>
...
<div class="modal-overlay" id="registrationModal">
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title">جلسه رایگان Django</h3>

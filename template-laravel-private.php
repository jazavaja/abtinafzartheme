<?php
/**
 * Template Name: آموزش خصوصی Laravel (تخصصی)
 */

custom_header(); ?>

<style>
    /* Modern Laravel Private Training Styles */
    .learning-container {
    ...
    /* Hero Section */
    .laravel-hero {
        background: linear-gradient(135deg, #440909 0%, #700f0f 50%, #7e0909 100%);
        color: white;
        position: relative;
        overflow: hidden;
        border-radius: 24px;
    ...
    .path-card {
        background: linear-gradient(145deg, rgba(239, 68, 68, 0.1), rgba(59, 130, 246, 0.05));
        padding: 2rem;
        border-radius: 20px;
        text-align: center;
    ...
    /* CTA Section */
    .laravel-cta {
        background: linear-gradient(135deg, #560707 0%, #3f1616 50%, #690606 100%);
        border-radius: 24px;
        padding: 4rem 2rem;
        text-align: center;
        position: relative;
    ...
    <div class="learning-container laravel-specialized">

        <!-- Hero Section -->
        <div class="learning-hero laravel-hero">
            <h1>🚀 تدریس خصوصی Laravel</h1>
            <p>یادگیری Laravel همراه با تمرین اختصاصی، <strong>بر اساس هدف، سطح و زمان شما</strong></p>
        ...
        <section id="why-private" class="section">
            <h2 class="section-title">چرا آموزش خصوصی Laravel؟</h2>
        ...
        <section class="section">
            ...
            <div class="paths-grid">
                <div class="path-card">
                    ...
                    <p>RESTful APIs, Authentication, Rate Limiting</p>
                </div>
                <div class="path-card">
                    <h4>📱 Full-Stack Applications</h4>
                    <p>Frontend Integration, SPA, Real-time Features</p>
                </div>
                <div class="path-card">
                    <h4>🛒 E-commerce Solutions</h4>
                    <p>Payment Integration, Order Management, Inventory</p>
                </div>
                <div class="path-card">
                    <h4>⚙️ Enterprise Applications</h4>
                    <p>Microservices, Queue Jobs, Advanced Patterns</p>
                </div>
            </div>
        </section>
        ...
        <section class="section">
            ...
            <div class="projects-grid">
                <div class="project-card">
                    ...
                    <h3>فروشگاه آنلاین Laravel</h3>
                    <p>سیستم فروش کامل با Laravel، پرداخت و مدیریت سفارش</p>
                ...
                <div class="project-card">
                    ...
                    <p>RESTful API با Laravel Sanctum و JWT</p>
                    <div class="project-tech">
                        <span class="tech-tag">Laravel</span>
                ...
                <div class="project-card">
                    <div class="project-icon">💬</div>
                    <h3>سیستم چت Real-time</h3>
                    <p>چت آنلاین با Laravel Broadcasting و WebSockets</p>
                    <div class="project-tech">
                        <span class="tech-tag">Laravel</span>
                    ...
                    <div class="project-difficulty">
                        <span class="difficulty-label">سطح: پیشرفته</span>
                        <span class="difficulty-bar">
                            <span class="difficulty-fill" style="width: 90%"></span>
                        </span>
                    </div>
                </div>
                ...
                <div class="project-card">
                    ...
                    <p>CMS سفارشی با Laravel Nova و Admin Panel</p>
                    <div class="project-tech">
                        <span class="tech-tag">Laravel</span>
                        <span class="tech-tag">Nova</span>
                        <span class="tech-tag">MySQL</span>
                    </div>
                    <div class="project-difficulty">
                        <span class="difficulty-label">سطح: متوسط</span>
                ...
                <div class="project-card">
                    ...
                    <h3>سیستم Queue Jobs</h3>
                    <p>پردازش پس‌زمینه با Laravel Queues و Redis</p>
                    <div class="project-tech">
                        <span class="tech-tag">Laravel</span>
                ...
                <div class="project-card">
                    <div class="project-icon">🔐</div>
                    <h3>سیستم احراز هویت پیشرفته</h3>
                    <p>Multi-factor Authentication و Role-based Access</p>
                    <div class="project-tech">
                        <span class="tech-tag">Laravel</span>
                        <span class="tech-tag">Spatie</span>
                        <span class="tech-tag">2FA</span>
                    </div>
                    <div class="project-difficulty">
                        <span class="difficulty-label">سطح: پیشرفته</span>
                        <span class="difficulty-bar">
                            <span class="difficulty-fill" style="width: 80%"></span>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <section class="section instructor-section">
            ...
            <div class="instructor-card">
                ...
                <div class="instructor-info">
                    <h3>محمدجوادسرلک</h3>
                    <p>9+ سال تجربه در توسعه Laravel و آموزش برنامه‌نویسی</p>
        ...
        <!-- Testimonials (Laravel-focused) -->
        <section class="testimonials-section" id="testimonials-section">
            <h2 class="section-title">نظرات دانشجویان Laravel</h2>
            <p style="text-align: center; color: #cbd5e1; margin-bottom: 2rem;">
                        ...
                        <div class="testimonial-card">
                            ...
                            <?php if ($audio_url) : ?>
                                <div class="voice-player">
                                    <audio controls style="width: 100%; height: 45px; border-radius: 15px; background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.3);">
        ...
        <section class="free-class-cta laravel-cta">
            <h2>🎯 جلسه رایگان — با هدف مشخص!</h2>
            <p>در جلسه اول، هدف شما را بررسی می‌کنیم و یک برنامهٔ شخصی‌سازی‌شده طراحی می‌کنیم.</p>
            <div class="cta-options">
                <button class="cta-btn" data-goal="API">API Development</button>
                <button class="cta-btn" data-goal="Full-Stack">Full-Stack</button>
                <button class="cta-btn" data-goal="E-commerce">E-commerce</button>
                <button class="cta-btn" data-goal="Enterprise">Enterprise</button>
    ...
    <div class="modal-overlay" id="registrationModal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">جلسه رایگان Laravel</h3>
